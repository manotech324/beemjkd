...
return [
    ...
    */
    ...
    'modules' => [
        'Auth' => [
            'enabled' => true,
            // Additional configurations for Auth
            'path' => base_path('Modules/Auth'),
            'assets' => public_path('modules/auth'),
            // Add more settings as needed...
        ],
        'Region' => [
            'enabled' => true,
            'path' => base_path('Modules/Region'),
            'assets' => public_path('modules/region'),
            // Add more settings as needed...
        ],
        'Shop' => [
            'enabled' => true,
            'path' => base_path('Modules/Shop'),
            'assets' => public_path('modules/shop'),
            // Add more settings as needed...
        ],
        'Employee' => [
            'enabled' => true,
            'path' => base_path('Modules/Employee'),
            'assets' => public_path('modules/employee'),
            // Add more settings as needed...
        ],
        'Vehicle' => [
            'enabled' => true,
            'path' => base_path('Modules/Vehicle'),
            'assets' => public_path('modules/vehicle'),
